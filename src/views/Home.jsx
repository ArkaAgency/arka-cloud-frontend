            ...
            <BasePageModel>
                ...
                <article className={'bg-gradient-to-b from-white to-gray-200 py-20'}>
                    <section className={'flex flex-wrap items-center justify-center mb-32'}>
                        <h2 className={'text-4xl font-bold w-1/4 text-center mb-32'}>{t`Over 1 million people and businesses`} <span className={'font-thin'}>{t`have choose Arka Cloud`}</span></h2>
